...
parser.add_argument('--variant', default='nominal', choices=['nominal','high_kv','very_high_kv','low_kv','low_current','heavy','hot','low_voltage'])
...
robots=[]; bases=[]
scale_kv = {'high_kv':2., 'very_high_kv':4., 'low_kv':.5}.get(args.variant,1.)
